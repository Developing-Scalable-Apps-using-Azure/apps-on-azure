...
namespace InternationalBakers.Controllers
{
    ...
    {
        private readonly Sbazuresqldb221936360Context _context;
        private readonly IDistributedCache _cache;

        public CookiesController(Sbazuresqldb221936360Context context, IDistributedCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Sbazuresqldb221936360Context.Cookies'  is null.");
            }
            var cookie = await _context.Cookies.FindAsync(id);
            if (cookie != null)
            {
